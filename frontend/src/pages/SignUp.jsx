    ...
    <div className='maincardsignup mt-10 rounded-md'>
     <div className='m-7'>
         ...
         <div className='flex flex-col mt-4'>
             ...
             <input autoComplete="off" type="text" value={confirmpassword} onChange={handleInputChange} name="confirmPassword" id="" className='bg-black text-sm placeholder-opacity-5 text-gray-200 h-10 pl-3 rounded-lg' placeholder='• • • • • •' />
         </div>
